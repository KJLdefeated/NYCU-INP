...
#define INITIAL_WIN_SIZE 150   // How many files can the server ask for in the same time
#define CLI_INIT_SEND 150      // How many files can the client send in the beginning
...
#define MAX_PACKETS 20          // Used to set the size of the stored_packet vector in Ack struct
